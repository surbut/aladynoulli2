...
def assemble_new_model_with_no_pcs():
    """
    ...
    base_path = "/Users/sarahurbut/Library/CloudStorage/Dropbox/censor_e_batchrun_vectorized_noPCS"
    ...
    for start_idx in range(0, total_patients, batch_size):
        ...
        filename = f"enrollment_model_VECTORIZED_W0.0001_batch_{start_idx}_{end_idx}.pt"
    ...
    output_path = "/Users/sarahurbut/aladynoulli2/pyScripts/new_thetas_with_pcs_retrospective_correct_noPC.pt"
    ...
    print(f"✅ Saved successfully!")
     ...
     # Save the combined thetas
    output_path = "/Users/sarahurbut/aladynoulli2/pyScripts/new_lambdas_with_pcs_retrospective_correctE_noPC.pt"
    print(f"Saving to: {output_path}")
...
def assemble_new_model_with_pcs():
    ...
    base_path = "/Users/sarahurbut/Library/CloudStorage/Dropbox/censor_e_batchrun_vectorized"
    total_patients = 400000
    batch_size = 10000
    ...
    # Save the combined thetas
    output_path = "/Users/sarahurbut/aladynoulli2/pyScripts/new_thetas_with_pcs_retrospective_correctE.pt"
    print(f"Saving to: {output_path}")
    ...
    print(f"✅ Saved successfully!")
     ...
     # Save the combined thetas
    output_path = "/Users/sarahurbut/aladynoulli2/pyScripts/new_lambdas_with_pcs_retrospective_correctE.pt"
    print(f"Saving to: {output_path}")
