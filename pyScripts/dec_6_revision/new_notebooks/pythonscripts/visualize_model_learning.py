...
def create_model_learning_figure(disease_name='ASCVD', output_dir=None):
    ...
    patient_file = Path('/Users/sarahurbut/aladynoulli2/pyScripts/dec_6_revision/new_notebooks/results/analysis') / f'prediction_drops_patients_{disease_name}.csv'
...
def create_multiple_precursors_figure(disease_name='ASCVD', output_dir=None):
    ...
    precursor_file = Path('/Users/sarahurbut/aladynoulli2/pyScripts/dec_6_revision/new_notebooks/results/analysis') / f'correlated_precursors_event_rates_{disease_name}.csv'
