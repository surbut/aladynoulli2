...
presence_matrix_exact <- data.frame(
  UID = all_variants$rsid,  # Use all_variants instead of all_variants_exact
  Angina = all_variants$rsid %in% angina$rsid,
  Cor_Athero = all_variants$rsid %in% cor_athero$rsid,
  Hypercholest = all_variants$rsid %in% hyperchol$rsid,
  MI = all_variants$rsid %in% mi$rsid,
  Acute_IHD = all_variants$rsid %in% acute_ihd$rsid,
  Chronic_IHD = all_variants$rsid %in% chronic_ihd$rsid,
  SIG5_AUC = all_variants$rsid %in% sig5$rsid
)
