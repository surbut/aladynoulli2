...
def load_external_scores_comparison():
    ...
    results_file = Path('/Users/sarahurbut/aladynoulli2/pyScripts/new_oct_revision/new_notebooks/results/comparisons/pooled_retrospective/external_scores_comparison.csv')
...
def plot_delphi_comparison(output_dir):
    ...
    delphi_file = Path('/Users/sarahurbut/aladynoulli2/pyScripts/new_oct_revision/new_notebooks/results/comparisons/pooled_retrospective/delphi_comparison_1yr_full.csv')
...
def main():
    output_dir = Path('/Users/sarahurbut/aladynoulli2/pyScripts/new_oct_revision/new_notebooks/results/comparisons/plots')
