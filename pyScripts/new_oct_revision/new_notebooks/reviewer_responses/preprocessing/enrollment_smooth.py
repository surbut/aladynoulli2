...
# Extract max follow-up time from ICD10 data
# This is the same as max_censor in the UKB code

# For AOU:
aou_df = pd.read_csv('/Users/sarahurbut/aladynoulli2/aladynoulli2/aou_sub.csv')
...
T = 52
E=torch.load('/Users/sarahurbut/Library/CloudStorage/DB_backup/aou_fromdl/E_binary.rds')
...
Y=torch.load('/Users/sarahurbut/Library/CloudStorage/DB_backup/aou_fromdl/Y_binary.rds')
...
# Same for MGB:
mgb_df = pd.read_csv('/Users/sarahurbut/aladynoulli2/mgb_icd_sub.csv')
mgb_max_followup = mgb_df.groupby('eid')['age_diag'].max().reset_index()
mgb_max_followup.columns = ['eid', 'max_censor']
mgb_max_followup['age'] = mgb_max_followup['max_censor']
mgb_max_followup.to_csv('/Users/sarahurbut/aladynoulli2/mgb_censor_info.csv', index=False)