...
def create_signature_deviation_plots(pathway_data, thetas, output_dir):
    """
...
def run_deviation_only_analysis(target_disease, n_pathways=4, output_dir='pathway_analysis_output'):
    """
    ...
    try:
        ...
        print(f"Method: Deviation-from-Reference (10-year lookback)")
        print("="*80)
    ...
    print("Using Deviation-from-Reference Method (10-year lookback)")
    ...
    create_signature_deviation_plots(pathway_data_dev, thetas, output_dir)
    ...
    # Step 7: Analyze disease sequences (doesn't require clustering)
