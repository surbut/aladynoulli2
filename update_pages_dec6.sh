#!/bin/bash
# Script to update GitHub Pages with latest notebook HTML exports (dec_6_revision)
# Usage: ./update_pages_dec6.sh

set -e

echo "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "="
echo "UPDATING GITHUB PAGES (DEC_6_REVISION)"
echo "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "=" "="
...
NOTEBOOK_DIR="pyScripts/dec_6_revision/new_notebooks/reviewer_responses"

find "$NOTEBOOK_DIR" -name "*.ipynb" ! -path "*/archive/*" ! -name "index.ipynb" | while read notebook; do
...
sed 's/\.ipynb/\.html/g' "$NOTEBOOK_DIR/README.md" > docs/reviewer_responses/README.md
echo "  ✓ README.md created early (links updated to .html)"

# Copy all HTML files maintaining directory structure
find "$NOTEBOOK_DIR" -name "*.html" -type f | while read html_file; do
    rel_path=${html_file#$NOTEBOOK_DIR/}
...
find "$NOTEBOOK_DIR" -name "*.html" -type f -delete
...
echo "  2. Commit: git add docs/ && git commit -m 'Update GitHub Pages (dec_6_revision)'"
echo "  3. Push: git push"
echo ""
echo "To push to GitHub Pages branch (docdec):"
echo "  1. Create/checkout branch: git checkout -b docdec"
echo "  2. Add and commit: git add docs/ && git commit -m 'Update GitHub Pages'"
echo "  3. Push branch: git push origin docdec"
echo ""
