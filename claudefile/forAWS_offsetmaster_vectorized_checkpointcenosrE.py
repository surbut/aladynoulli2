...
def load_model_essentials(base_path='/Users/sarahurbut/Library/CloudStorage/Dropbox-Personal/data_for_running/'):
    ...
    E = torch.load(base_path + 'E_matrix_corrected.pt')  # Use corrected E matrix
...
end_index = end_index
## already did 1:3, so starting at 4
for age_offset in range(4, 10):  # Ages 0-10 years after enrollment (11 total: 0,1,2,...,10)
    ...
    with torch.no_grad():
        ...
        filename = f"/Users/sarahurbut/Library/CloudStorage/Dropbox-Personal/age_offset_local_vectorized_E_corrected/pi_enroll_fixedphi_age_offset_{age_offset}_sex_{start_index}_{end_index}_try2_withpcs_newrun_pooledall.pt"
        torch.save(pi, filename)
       
        print(f"Saved predictions to {filename}")

    filename = f"/Users/sarahurbut/Library/CloudStorage/Dropbox-Personal/age_offset_local_vectorized_E_corrected/model_enroll_fixedphi_age_offset_{age_offset}_sex_{start_index}_{end_index}_try2_withpcs_newrun_pooledall.pt"
    torch.save({
