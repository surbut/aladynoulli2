...
def main():
    ...
    # Train the model
    print(f"\nTraining model for {args.num_epochs} epochs (VECTORIZED_nolr)...")
    ...
    output_path = output_dir / f'enrollment_model_VECTORIZED_W{args.W}_nolr_batch_{args.start_index}_{args.end_index}.pt'
    ...
    torch.save({
        ...
        'version': 'VECTORIZED_nolr',  # Mark this as the vectorized version
    }, output_path)
