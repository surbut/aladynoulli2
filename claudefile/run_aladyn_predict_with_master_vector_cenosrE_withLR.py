...
nohup python run_aladyn_predict_with_master_vector_cenosrE_withLR.py \
    ...
    --output_dir /Users/sarahurbut/Library/CloudStorage/Dropbox/enrollment_predictions_fixedphi_correctedE_vectorized_withLR/ \
    --max_batches 5 \
    --lambda_reg 0.01 \
    > predict_correctedE_vectorized_withLR.log 2>&1 &
"""
