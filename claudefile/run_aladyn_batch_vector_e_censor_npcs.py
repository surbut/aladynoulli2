...
def main():
    ...
    parser.add_argument('--output_dir', type=str,
                       default='/Users/sarahurbut/Library/CloudStorage/Dropbox/censor_e_batchrun_vectorized_noPCS/',
    ...
    parser.add_argument('--include_pcs', action='store_true',
                       help='Include principal components in the model')
    parser.add_argument('--no_pcs', dest='include_pcs', action='store_false',
                       help='Exclude principal components (default: no PCs)')
    parser.set_defaults(include_pcs=False)
