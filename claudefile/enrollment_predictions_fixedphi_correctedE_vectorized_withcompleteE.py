...
nohup python run_aladyn_predict_with_master.py \
    --trained_model_path /Users/sarahurbut/Library/CloudStorage/Dropbox-Personal/data_for_running/master_for_fitting_pooled_correctedE.pt \
    --output_dir /Users/sarahurbut/Library/CloudStorage/Dropbox/enrollment_predictions_fixedphi_correctedE_vectorized_withcompleteE/ \
    --max_batches 40 \
    > predict_correctedE_vectorized_withcompleteE.log 2>&1 &
"""
...
def load_model_essentials(base_path):
    ...
    E = torch.load(base_path + 'E_matrix_corrected.pt', weights_only=False)  # Enrollment data for prediction
